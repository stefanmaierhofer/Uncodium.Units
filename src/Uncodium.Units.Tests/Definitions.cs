...
namespace Uncodium.Units.Tests
{
    ...
    public class Definitions
    {
        ...
        [Test] public void Foot_International_2()   => Assert.IsTrue(   1 * International.Foot      ==  US.Survey.Foot              *    new Rational(999_998, 1_000_000)   );
        [Test] public void Foot_International_3()   => Assert.IsTrue(   1 * International.Foot      ==  Meter                       *    12 * new Rational(254, 10_000)     );
        [Test] public void Foot_International_4()   => Assert.IsTrue(   1 * International.Foot      ==  US.Survey.Foot              *    new Rational(254, 10_000) * new Rational(3_937, 100) );
        ...
        [Test] public void Mile_International_2()   => Assert.IsTrue(   1 * International.Mile      ==  US.Survey.Mile              *    new Rational(999_998, 1_000_000)   );
                                                                                                                                    
                                                                                                                                    
        [Test] public void Link_UsSurvey()          => Assert.IsTrue(   1 * US.Survey.Link          ==  US.Survey.Chain             *    new Rational(1, 100)               );
        [Test] public void Foot_UsSurvey()          => Assert.IsTrue(   1 * US.Survey.Foot          ==  Meter                       *    new Rational(1_200, 3_937)         );
        ...
        public void NewtonMeter_2()
        {
            ...
            var b = Rational.Pow(10, -7).ToFloat();
            Assert.IsTrue(af == b);
        }

        /*
         * TODO:
         * The Boltzmann constant (kB or k) is the gas constant Rational divided by the Avogadro constant N_A:
         */
    }
}
