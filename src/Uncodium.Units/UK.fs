...
module UK =
    ...
    module LiquidVolume =
        ...
        let Gallon          = U("gallon",               "gal",      SI.Liter,               Rational(454_609, 100_000)      )
        ...
        let Quart           = U("quart",                "qt",       Gallon,                 Rational(1, 4)                  )
        /// A pint is equal to 1/2 quart.
        let Pint            = U("pint",                 "pt",       Quart,                  Rational(1, 2)                  )
        /// A gill is equal to 1/4 pint.
        let Gill            = U("gill",                 "gill",     Pint,                   Rational(1, 4)                  )
        /// A fluid ounce is equal to 1/5 gill.
        let FluidOunce      = U("gill",                 "fl oz",    Gill,                   Rational(1, 5)                  )
        /// A fluid drachm is equal to 1/8 fluid ounce.
        let FluidDrachm     = U("fluid drachm",         "fl dr",    FluidOunce,             Rational(1, 8)                  )
        /// A minim is equal to 1/60 fluid drachm.
        let Minim           = U("minim",                "minim",    FluidDrachm,            Rational(1, 60)                 )
